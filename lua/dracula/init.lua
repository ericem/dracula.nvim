...
highlight("Comment", colors.comment, nil, "italic", nil)
...
-- Notify
  highlight('NotifyERRORBorder', colors.bright_red, nil, nil, nil)
  highlight('NotifyWARNBorder', colors.orange, nil, nil, nil)
  highlight('NotifyINFOBorder', colors.bright_green, nil, nil, nil)
  highlight('NotifyDEBUGBorder', colors.purple, nil, nil, nil)
  highlight('NotifyTRACEBorder', colors.pink, nil, nil, nil)
  highlight('NotifyERRORIcon', colors.red, nil, nil, nil)
  highlight('NotifyWARNIcon', colors.orange, nil, nil, nil)
  highlight('NotifyINFOIcon', colors.green, nil, nil, nil)
  highlight('NotifyDEBUGIcon', colors.bright_magenta, nil, nil, nil)
  highlight('NotifyTRACEIcon', colors.pink, nil, nil, nil)
  highlight('NotifyERRORTitle',  colors.red, nil, nil, nil)
  highlight('NotifyWARNTitle', colors.orange, nil, nil, nil)
  highlight('NotifyINFOTitle', colors.green, nil, nil, nil)
  highlight('NotifyDEBUGTitle',  colors.bright_magenta, nil, nil, nil)
  highlight('NotifyTRACETitle', colors.pink, nil, nil, nil)
  highlight('NotifyERRORBody', colors.white, nil, nil, nil)
  highlight('NotifyWARNBody', colors.white, nil, nil, nil)
  highlight('NotifyINFOBody', colors.white, nil, nil, nil)
  highlight('NotifyDEBUGBody', colors.white, nil, nil, nil)
  highlight('NotifyTRACEBody', colors.white, nil, nil, nil)
